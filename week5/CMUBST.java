...
public class CMUBST <T extends Comparable<T>> implements Iterable<T>
{
    public static void main(String[] args)
    {
        Integer[] a = {1,5,2,7,4};
        CMUBST<Integer> CMUBST = new CMUBST<Integer>();
        for(Integer n : a) CMUBST.insert(n);

        CMUBST.preOrderTraversal();
        System.out.println();

        //testing comparator
        //build a mirror CMUBST with a rule:  Left > Parent > Right
        //code for the comparator at the bottom of the file
        CMUBST = new CMUBST<Integer>(new MyComp1());
        for(Integer n : a) CMUBST.insert(n);

        CMUBST.preOrderTraversal();
        System.out.println();
        CMUBST.inOrderTraversal();
        System.out.println();

        for(Integer n : CMUBST) System.out.print(n);
        System.out.println();

        System.out.println(CMUBST);

        //testing restoring a tree from two given traversals
        CMUBST.restore(new Integer[] {11,8,6,4,7,10,19,43,31,29,37,49},
        ...
        //testing diameter
        System.out.println("diameter = " + CMUBST.diameter());
        //testing width
        System.out.println("width = " + CMUBST.width());
    }
    ...
    public CMUBST(Comparator<T> comp)
    {
        root = null;
        comparator = comp;
    }
    ...
    //This method restores a CMUBST given preorder and inorder traversals
